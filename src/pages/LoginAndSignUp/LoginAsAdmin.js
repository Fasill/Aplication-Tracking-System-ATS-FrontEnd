...
const LoginAsChannelPartner = () => {
  ...
  return ( 
    <div className='flex justify-between w-full   '>
      ...
      <div className='bg-white w-full h-screen  flex align-center justify-center items-center p-8 ' >{isByPassword?<  LoginForm  tittle = "Login as channel partner" role = "Admin" />:<  LoginFormByEmail tittle = "Login as channel partner" role = "Admin" />}</div>

    </div>
  );
}

export default LoginAsChannelPartner;
