...
const LoginAsSupplier = () => {
  ...
  return ( 
    <div className='flex justify-between w-full   '>
      ...
      <div className='bg-white w-full h-screen  flex align-center justify-center items-center p-8 ' >{isByPassword?<  LoginForm  tittle = "Login as Supplier" role = "Company" />:<  LoginFormByEmail tittle = "Login as Supplier" role = "As Supplier" />}</div>
    </div>
  );
}

export default LoginAsSupplier;
